  ...
  function Bookshelf_followed() {
    ...
    const [datamember, setDataMember] = useState<UsersInterface | undefined>(undefined);
    ...
    useEffect(() => {
      if (datamember?.FollowedCartoon?.ID) {
        getCartoonIDfromMemberID(datamember.FollowedCartoon.ID);//ยังไม่แล้ว
      }
    }, [datamember]);
